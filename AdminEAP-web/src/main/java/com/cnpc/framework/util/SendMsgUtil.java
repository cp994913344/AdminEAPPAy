...
public class SendMsgUtil {
    ...
    static final String accessKeyId = "LTAIogGYX1Hmk9Z4";
    static final String accessKeySecret = "wT5JMnGqdiAmODG9nHVGgzUNF7GFnJ";
    ...
    public static Map<String, Object> sendSmsCode(String phone)throws ClientException, InterruptedException{
